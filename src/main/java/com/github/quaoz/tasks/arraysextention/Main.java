package com.github.quaoz.tasks.arraysextention;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		RotatedString[] rotatedStrings = Arrays.stream(wordArray).map(com.github.quaoz.tasks.arraysextention.Main::rotateString).toArray(RotatedString[]::new);
